...
dCBOR objects (`seed`, `psbt`). It does not implement application cryptography
or trust policies. L5 output is untrusted structured data; signing and key use
are host policy.
...
| v1/v2 mixup (`crypto-seed` / tag 300)          | Medium               | v1 tokens fail `UnexpectedType` against v2 codecs                                                                        |
